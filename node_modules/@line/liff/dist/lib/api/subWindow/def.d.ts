import LiffError from '../../../lib/util/LiffError';
import { SUB_WINDOW_SUBMIT_STATUS, SUB_WINDOW_CANCEL_STATUS, SUB_WINDOW_CLOSE_STATUS, SUB_WINDOW_ERROR_STATUS, SUB_WINDOW_HEALTH_CHECK_MESSAGE } from '../../util/consts';
interface Base {
    error?: string;
    error_description?: string;
}
export declare type EventType = typeof SUB_WINDOW_ERROR_STATUS | typeof SUB_WINDOW_CANCEL_STATUS | typeof SUB_WINDOW_CLOSE_STATUS | typeof SUB_WINDOW_SUBMIT_STATUS;
